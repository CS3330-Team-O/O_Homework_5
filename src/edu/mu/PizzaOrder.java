...
public class PizzaOrder {
	...
	// if there are any uncooked pizza's then true is returned and otherwise false
	// is returned
	...
	// Method checkout calculates the total price in order list if there are no
	// uncooked pizza's
	...
	// Method takes an integer OrderID and a CookingStyleType for a pizza the method
	// finds the pizza with that order id
	// once the correct pizza is found, the method will setCookingStrategy and use
	// the cookingStrategyType to invoke the correct cook() method
	// Once the cooking is done, true is returned. else if the pizza order ID is not
	// found then false is returned.s
